        ...
        <form onSubmit={handleSubmit}>
          <div className="row g-3">
            ...
            <div className="col-12 col-md-6">
              <label htmlFor="employee-name" className="form-label">Name</label>
              <input
                id="employee-name"
                name="name"
                type="text"
            ...
            {/* Role */}
            <div className="col-12 col-md-6">
              <label htmlFor="employee-role" className="form-label">Role</label>
              <input
                id="employee-role"
                name="role"
                type="text"
            ...
            {/* Mobile */}
            <div className="col-12 col-md-6">
              <label htmlFor="employee-mobile" className="form-label">Mobile</label>
              <input
                id="employee-mobile"
                name="mobile"
                type="tel"
            ...
            {/* Date of Birth */}
            <div className="col-12 col-md-6">
              <label htmlFor="employee-dob" className="form-label">Date of Birth</label>
              <input
                id="employee-dob"
                name="dob"
                type="date"
            ...
            {/* Photo Upload */}
            <div className="col-12 col-md-6">
              <label htmlFor="employee-photo" className="form-label">Photo</label>
              <input
                id="employee-photo"
                name="photo"
                type="file"
            ...
            {/* Confirm Password */}
            <div className="col-12 col-md-6">
              <label htmlFor="employee-confirm-password" className="form-label">Confirm Password</label>
              <input
